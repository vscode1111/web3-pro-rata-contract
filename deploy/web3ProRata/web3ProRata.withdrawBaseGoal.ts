...
const func: DeployFunction = async (hre: HardhatRuntimeEnvironment): Promise<void> => {
  await callWithTimerHre(async () => {
    ...
    console.log(`${WEB3_P_PRO_RATA_NAME} ${web3ProRataAddress} is withdrawing goal...`);
    ...
    await waitTx(
      owner2WEB3ProRata.withdrawBaseGoal(TX_OVERRIDES),
      'withdrawBaseGoal',
...
func.tags = [`${WEB3_P_PRO_RATA_NAME}:withdraw-base-goal`];
